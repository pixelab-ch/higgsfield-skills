...
- [x] **Phase 3: Bulk Refactor — Remaining 14 Skills** — Apply the validated pilot template to all remaining skills in dependency-aware order, adding the media_upload branch for the 4 I2V skills (04, 08, 09, 10)
- [x] **Phase 4: Install Script** — Revise install.sh to target the correct shared Claude Code + Desktop path, handle shared/ directory, add --all/--list/--target flags, idempotency
...
| 3. Bulk Refactor — Remaining 14 Skills | 6/6 | ✅ Complete (verified 4/4) | 2026-05-25 |
| 4. Install Script | 1/1 | ✅ Complete (PKG-01..04) | 2026-05-25 |
| 5. Spec Accuracy Pass + Documentation | 1/1 | ✅ Complete (SPEC-02, DOC-01/02) | 2026-05-25 |
